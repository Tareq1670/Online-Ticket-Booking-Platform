            ...
            <div className="mx-auto max-w-7xl">
                ...
                {isFraud && (
                    <div className="mb-8 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-4 text-sm font-medium text-rose-700 shadow-sm dark:border-rose-800 dark:bg-rose-900/20 dark:text-rose-300">
                        Your vendor account has been marked as fraud. You cannot
                        add new tickets, and your public tickets should remain
                        hidden according to platform rules.
                    </div>
                )}
...
const StatCard = ({ title, value, color = "green" }) => {
    const styles = {
        ...
        emerald:
            "from-emerald-50 to-teal-50 text-emerald-700 dark:from-emerald-900/10 dark:to-teal-900/10 dark:text-emerald-400",
